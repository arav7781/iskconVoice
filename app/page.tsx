...
const FloatingElements = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      <div className="absolute top-20 left-10 text-6xl opacity-10 animate-float text-secondary">🕉️</div>
      <div
        className="absolute top-40 right-20 text-4xl opacity-15 animate-float-reverse text-accent"
        style={{ animationDelay: "2s" }}
      >
        🪷
      </div>
      <div
        className="absolute bottom-40 left-20 text-5xl opacity-10 animate-float text-primary"
        style={{ animationDelay: "4s" }}
      >
        🙏
      </div>
      <div
        className="absolute bottom-20 right-10 text-3xl opacity-20 animate-float-reverse text-secondary"
        style={{ animationDelay: "1s" }}
      >
        ✨
      </div>
      <div
        className="absolute top-1/2 left-1/4 text-2xl opacity-15 animate-float text-accent"
        style={{ animationDelay: "3s" }}
      >
        📿
      </div>
      <div
        className="absolute top-1/3 right-1/3 text-3xl opacity-10 animate-float-reverse text-primary"
...
export default function ISKCONLandingPage() {
  ...
  // Scroll to spiritual journey section
  const scrollToJourney = () => {
    const journeySection = document.getElementById("spiritual-journey")
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 py-20">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-800/90 via-blue-700/90 to-teal-800/90 z-0"></div>
              <span className="flex items-center space-x-3 relative z-10 text-white font-bold">
              ...
              >
                <Card className="h-full bg-card/90 backdrop-blur-sm border-primary/20 hover:border-accent/50 transition-all duration-300 hover:shadow-xl group">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button className="w-full mt-4 bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary text-primary-foreground">
                      Learn More
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-3xl p-12 border border-blue-600/20 shadow-2xl">
              ...
              <p className="text-xl md:text-2xl text-teal-600 mb-8 leading-relaxed">
                हरे कृष्ण हरे कृष्ण कृष्ण कृष्ण हरे हरे
                <br />
                हरे राम हरे राम राम राम हरे हरे
              </p>
